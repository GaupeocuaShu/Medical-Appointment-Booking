        ...
        <div class="invoice">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <address>
                      ...
                      <span style="text-transform: uppercase;color:white" class="badge bg-dark">{{$schedule->status}}</span><br>
                    </address>
                  </div>
                  <div class="col-md-6 text-md-right">
                    <address>
          ...
          <div class="text-md-right">
            <div class="float-lg-left mb-lg-0 mb-3">
              <a href="{{route("admin.schedule.pending-schedule")}}" class="btn btn-danger btn-icon icon-left"><i class="fa-solid fa-right-from-bracket"></i> Back</a>
            </div>
