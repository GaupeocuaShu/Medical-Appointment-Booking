{{-- @php
    $string ="2024-03-10 canceled"; 
    $var1 = explode(" ",$string)[0];
    $var2 = explode(" ",$string)[1]; 
    dd($var1 ."-". $var2);
@endphp --}}
...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <a href="{{route("admin.doctor.index")}}" class="btn btn-danger mb-3"><i class="fa-solid fa-right-from-bracket"></i> Back</a>
                  <div class="card">
