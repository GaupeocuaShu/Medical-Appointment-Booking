                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('doctor.working-time.index') }}" class="text-white btn btn-danger"><i
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('doctor.working-time.get-working-time-for-edit') }}",
                dataType: "JSON",
            ...
            $(".update-working-time").on("click", function(e) {
                ...
                $.ajax({
                    type: "PUT",
                    url: "{{ route('doctor.working-time.update') }}",
                    data: data,
                    dataType: "JSON",
                    beforeSend: function() {
